...
- Then read [Model Boundaries](../reference/model_boundaries.md) for the per-model handoff map.
...
- the enabled workflow surface is the shared projection of settings + state that decides the active run shape
