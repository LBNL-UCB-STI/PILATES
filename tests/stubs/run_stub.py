...
def main():
    ...
    parser.add_argument('--model_name', required=True, help='Name of the model being stubbed')
    parser.add_argument('--cwd', required=True, help='Current working directory for the model')
    parser.add_argument('--config_name', required=True, help='Name of the configuration file')
