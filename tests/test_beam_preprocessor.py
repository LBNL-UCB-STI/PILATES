...
from pilates.beam.preprocessor import _prepare_beam_zone_shapefile, BeamPreprocessor # Import BeamPreprocessor
from pilates.config.models import load_config
...
class TestBeamPreprocessor:
    ...
    def test_shapefile_sorting_and_indexing(
        ...
        output_shapefile_path = preprocessor.prepare_beam_zone_shapefile(mock_workspace, model_run_hash)
