...
def mock_dependencies():
    with patch("pilates.utils.io.get_setting") as mock_get_setting, patch(
        "pilates.utils.io.load_config"
    ) as mock_load_config:
...
class TestComputeModelEnabledFlags:
    ...
    def test_all_models_enabled_nested_settings(
    ...
    def test_traffic_assignment_disabled_by_static_skims(
        self, mock_dependencies, mock_settings_data
    ):
        mock_get_setting, _ = mock_dependencies
    ...
    def test_replanning_disabled_by_replan_iters_zero(
        self, mock_dependencies, mock_settings_data
    ):
        mock_get_setting, _ = mock_dependencies
    ...
    def test_replanning_disabled_for_polaris_activity_demand(
        self, mock_dependencies, mock_settings_data
    ):
        mock_get_setting, _ = mock_dependencies
...
class TestParseArgsAndSettings:
    ...
    def test_default_args_and_settings(
        self,
        mock_compute_flags,
        mock_arg_parser,
        mock_dependencies,
    ...
    @patch("argparse.ArgumentParser")
    @patch("pilates.utils.io.compute_model_enabled_flags")
    def test_custom_config_and_stage_files(
        self,
        mock_compute_flags,
        mock_arg_parser,
        mock_dependencies,
    ...
    @patch("argparse.ArgumentParser")
    @patch("pilates.utils.io.compute_model_enabled_flags")
    def test_household_sample_size_value_error(
        self,
        mock_compute_flags,
        mock_arg_parser,
        mock_dependencies,
    ...
    @patch("argparse.ArgumentParser")
    @patch("pilates.utils.io.compute_model_enabled_flags")
    def test_atlas_beamac_value_error(
        self,
        mock_compute_flags,
        mock_arg_parser,
        mock_dependencies,
