...
class TestZoneIdWorkflow:
    ...
    def test_zone_id_end_to_end_alignment_workflow(self, mock_asim_copy, mock_beam_copy, mock_download_geoms, mock_get_school_enrollment, mock_get_college_enrollment):
        ...
        asim_preprocessor = ActivitysimPreprocessor("activitysim", self.state, self.provenance_tracker)
        ...
        assert sorted_zones_gdf.index.name == self.settings.shared.geography.zones.activitysim_index_col
        ...
        print("✅ STEP 2 PASSED: BEAM preprocessor correctly creates a sorted zone shapefile.")
        ...
        try:
            ...
            pytest.fail(f"verify_skim_zone_order failed unexpectedly on a correct skim file: {e}")

        print("✅ STEP 3a PASSED: Skim verification correctly passed for an aligned skim file.")
        ...
        print("✅ STEP 3b PASSED: Skim verification correctly failed for a misaligned skim file.")
        ...
        land_use_path = os.path.join(self.workspace.get_asim_mutable_data_dir(), "land_use.csv")
