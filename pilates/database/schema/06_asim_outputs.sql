...
CREATE TABLE IF NOT EXISTS households_asim_out (
    ...
    income_in_thousands VARCHAR, -- Household income in thousands
...
CREATE TABLE IF NOT EXISTS non_mandatory_tour_destination_accessibility_asim_out (
    ...
    income BIGINT, -- Household income
    income_in_thousands VARCHAR, -- Household income in thousands
    income_segment BIGINT, -- Household income segment
    ...
    num_college_age BIGINT, -- Number of college-aged individuals
    num_drivers BIGINT, -- Number of drivers
    num_non_workers BIGINT, -- Number of non-workers
    num_workers BIGINT, -- Number of workers
    num_young_adults BIGINT, -- Number of young adults
    num_young_children BIGINT, -- Number of young children
    persons BIGINT, -- Number of persons
    veh BIGINT, -- Number of vehicles
