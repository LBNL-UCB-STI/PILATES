...
class ActivitysimPostprocessUsimHouseholdsUpdated(SQLModel, table=True):
    ...
    lcm_county_id: Optional[str] = Field(
        default=None, sa_column=Column("lcm_county_id", String, nullable=True)
    )
    ...
    hh_type: Optional[float] = Field(
        default=None, sa_column=Column("hh_type", Float, nullable=True)
    )
...
class ActivitysimPostprocessUsimPersonsUpdated(SQLModel, table=True):
    ...
    school_id: Optional[str] = Field(
        default=None, sa_column=Column("school_id", String, nullable=True)
    )
    ...
    relate: Optional[float] = Field(
        default=None, sa_column=Column("relate", Float, nullable=True)
    )
    ...
    mar: Optional[float] = Field(
        default=None, sa_column=Column("MAR", Float, nullable=True)
    )
...
class UrbansimPostprocessUsimBlocksTable(SQLModel, table=True):
    ...
    state_id: Optional[str] = Field(
        default=None, sa_column=Column("state_id", String, nullable=True)
    )
    block_group_id: Optional[str] = Field(
        default=None, sa_column=Column("block_group_id", String, nullable=True)
    )
    ...
    tract_id: Optional[str] = Field(
        default=None, sa_column=Column("tract_id", String, nullable=True)
    )
    sum_acres: Optional[float] = Field(
        default=None, sa_column=Column("sum_acres", Float, nullable=True)
    )
    square_meters_land: Optional[int] = Field(
        default=None, sa_column=Column("square_meters_land", BigInteger, nullable=True)
    )
    employment_capacity: Optional[float] = Field(
        default=None, sa_column=Column("employment_capacity", Float, nullable=True)
    )
    mpo_id: Optional[str] = Field(
        default=None, sa_column=Column("MPO_ID", String, nullable=True)
    )
    ...
    county_id: Optional[str] = Field(
        default=None, sa_column=Column("county_id", String, nullable=True)
    )
    cousub: Optional[str] = Field(
        default=None, sa_column=Column("cousub", String, nullable=True)
    )
    node_id: Optional[int] = Field(
        default=None, sa_column=Column("node_id", BigInteger, nullable=True)
    )
...
class UrbansimPostprocessUsimTazZoneGeomsTable(SQLModel, table=True):
    ...
    shape_are: Optional[float] = Field(
        default=None, sa_column=Column("Shape__Are", Float, nullable=True)
    )
    shape_len: Optional[float] = Field(
        default=None, sa_column=Column("Shape__Len", Float, nullable=True)
    )
    geometry: Optional[str] = Field(
        default=None, sa_column=Column("geometry", String, nullable=True)
    )
...
class UrbansimPostprocessUsimHouseholdsTable(SQLModel, table=True):
    ...
    cars: Optional[float] = Field(
        default=None, sa_column=Column("cars", Float, nullable=True)
    )
    serialno: Optional[str] = Field(
        default=None, sa_column=Column("serialno", String, nullable=True)
    )
    hh_workers: Optional[str] = Field(
        default=None, sa_column=Column("hh_workers", String, nullable=True)
    )
...
class UrbansimPostprocessUsimJobsTable(SQLModel, table=True):
    ...
    sector_id: Optional[str] = Field(
        default=None, sa_column=Column("sector_id", String, nullable=True)
    )
    agg_sector: Optional[str] = Field(
        default=None, sa_column=Column("agg_sector", String, nullable=True)
    )
    block_id: Optional[str] = Field(
        default=None,
        sa_column=Column(
...
class UrbansimPostprocessUsimResidentialUnitsTable(SQLModel, table=True):
    ...
    year_built: Optional[int] = Field(
        default=None, sa_column=Column("year_built", BigInteger, nullable=True)
    )
    building_type_id: Optional[int] = Field(
        default=None, sa_column=Column("building_type_id", BigInteger, nullable=True)
    )
    acs_13_rent: Optional[float] = Field(
        default=None, sa_column=Column("ACS_13_rent", Float, nullable=True)
    )
    block_group_id: Optional[str] = Field(
        default=None, sa_column=Column("block_group_id", String, nullable=True)
    )
    ...
    acs_18_rent: Optional[float] = Field(
        default=None, sa_column=Column("ACS_18_rent", Float, nullable=True)
    )
    acs_18_value: Optional[float] = Field(
        default=None, sa_column=Column("ACS_18_value", Float, nullable=True)
    )
    acs_13_value: Optional[float] = Field(
        default=None, sa_column=Column("ACS_13_value", Float, nullable=True)
    )
...
class UrbansimPostprocessUsimGraveyardTable(SQLModel, table=True):
    ...
    school_zone_id: Optional[int] = Field(
        default=None, sa_column=Column("school_zone_id", Integer, nullable=True)
    )
    school_id: Optional[str] = Field(
        default=None, sa_column=Column("school_id", String, nullable=True)
    )
