...
class GenericRunner(
    ...
    def run_container(
        ...
        consist_volume_modes = {
            host: mode for host, _container, mode in mounts if mode != "rw"
        }
        volume_mode_kwargs: dict[str, dict[str, str]] = {}
        if consist_volume_modes:
            volume_mode_kwargs["volume_modes"] = consist_volume_modes
