...
if  [ $# -eq 2 ]
    then
        ...
        gcloud alpha storage cp -r -n pilates/urbansim/output/year* gs://beam-core-outputs/$2/urbansim/
        ...
        gcloud alpha storage cp -n log_pilates_$1.out gs://beam-core-outputs/$2/log_pilates_$1.out
