...
export DURATION=${2:?ARG \#2 "DURATION" not specified}
export BEAM_INTERVAL=${3:?ARG \#2 "BEAM_INTERVAL" not specified}
export BAUS_ITER_FREQ=${4:?ARG \#3 "BAUS_ITER_FREQ" not specified}
