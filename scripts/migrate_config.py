...
class ConfigMigrator:
    ...
    def _migrate_infrastructure_config(self) -> Dict[str, Any]:
        ...
        singularity_images = {
            k: v for k, v in self.legacy.get('singularity_images', {}).items()
            if v is not None
        }
        docker_images = {
            k: v for k, v in self.legacy.get('docker_images', {}).items()
            if v is not None
        }
    ...
    def _migrate_urbansim_config(self) -> Dict[str, Any]:
        ...
        return {
            ...
            'client_data_folder': self.legacy.get('usim_client_data_folder', '/base/demos_urbansim/data/'),
            'input_file_template': self.legacy.get('usim_formattable_input_file_name', 'custom_mpo_{region_id}_model_data.h5'),
            'input_file_template_year': self.legacy.get('usim_formattable_input_file_name_year', 'custom_mpo_{region_id}_model_data_{start_year}.h5'),
    ...
    def _migrate_atlas_config(self) -> Dict[str, Any]:
        ...
        return {
            'host_input_folder': self.legacy.get('atlas_host_input_folder', 'pilates/atlas/atlas_input'),
            'warmstart_input_folder': self.legacy.get('atlas_warmstart_input_folder', 'pilates/atlas/atlas_input'),
            'host_mutable_input_folder': self.legacy.get('atlas_host_mutable_input_folder', 'atlas/atlas_input'),
            'host_output_folder': self.legacy.get('atlas_host_output_folder', 'atlas/atlas_output'),
            'container_input_folder': self.legacy.get('atlas_container_input_folder', '/atlas_input'),
            'container_output_folder': self.legacy.get('atlas_container_output_folder', '/atlas_output'),
    ...
    def _migrate_activitysim_config(self) -> Dict[str, Any]:
        ...
        return {
            ...
            'local_input_folder': self.legacy.get('asim_local_input_folder', 'pilates/activitysim/data/'),
            'local_mutable_data_folder': self.legacy.get('asim_local_mutable_data_folder', 'activitysim/data/'),
            'local_output_folder': self.legacy.get('asim_local_output_folder', 'activitysim/output/'),
            'local_configs_folder': self.legacy.get('asim_local_configs_folder', 'pilates/activitysim/configs/'),
            'local_mutable_configs_folder': self.legacy.get('asim_local_mutable_configs_folder', 'activitysim/configs/'),
            'validation_folder': self.legacy.get('asim_validation_folder', 'pilates/activitysim/validation'),
            'subdir': self.legacy.get('asim_subdir', 'configs'),
            'main_configs_dir': self.legacy.get('asim_main_configs_dir', 'configs_extended'),
            'region_mappings': {
            ...
            'replan_after': self.legacy.get('replan_after', 'non_mandatory_tour_scheduling'),
            'final_plans_folder': self.legacy.get('final_asim_plans_folder', 'pilates/activitysim/output/final_plans'),
        }
    ...
    def _migrate_beam_config(self) -> Dict[str, Any]:
        ...
        return {
            ...
            'local_input_folder': self.legacy.get('beam_local_input_folder', 'pilates/beam/production/'),
            'local_mutable_data_folder': self.legacy.get('beam_local_mutable_data_folder', 'beam/input/'),
            'local_output_folder': self.legacy.get('beam_local_output_folder', 'beam/beam_output/'),
            ...
            'skims_shapefile': self.legacy.get('beam_skims_shapefile', 'shape/zones.shp'),
            'skim_zone_source_id_col': self.legacy.get('skim_zone_source_id_col', 'sk_zone'),
            'skim_zone_geoid_col': self.legacy.get('skim_zone_geoid_col', 'geoid10'),
            'discard_plans_every_year': self.legacy.get('discard_plans_every_year', False),
            ...
            'asim_transit_measure_map': self.legacy.get('beam_asim_transit_measure_map', {}),
            'asim_ridehail_measure_map': self.legacy.get('beam_asim_ridehail_measure_map', {}),
    ...
    def _migrate_postprocessing_config(self) -> Dict[str, Any]:
        ...
        return {
            'output_folder': self.legacy.get('postprocessing_output_folder', 'pilates/postprocessing/output'),
            'mep_output_folder': self.legacy.get('mep_local_output_folder', 'pilates/postprocessing/MEP/'),
...
def migrate_config_file(
    ...
    try:
        ...
        with open(output_path, 'w') as f:
            ...
            f.write("# =============================================================================\n")
            yaml.dump({'run': new_config['run']}, f, default_flow_style=False, sort_keys=False, width=120)
            f.write("\n")
            ...
            f.write("# =============================================================================\n")
            yaml.dump({'shared': new_config['shared']}, f, default_flow_style=False, sort_keys=False, width=120)
            f.write("\n")

            # Infrastructure
            f.write("# =============================================================================\n")
            f.write("# INFRASTRUCTURE CONFIGURATION\n")
            f.write("# Container management (Docker/Singularity) and execution environment\n")
            f.write("# =============================================================================\n")
            yaml.dump({'infrastructure': new_config['infrastructure']}, f, default_flow_style=False, sort_keys=False, width=120)
            f.write("\n")
            ...
            if 'urbansim' in new_config:
                ...
                f.write("# =============================================================================\n")
                yaml.dump({'urbansim': new_config['urbansim']}, f, default_flow_style=False, sort_keys=False, width=120)
                f.write("\n")
            ...
            if 'atlas' in new_config:
                ...
                f.write("# =============================================================================\n")
                yaml.dump({'atlas': new_config['atlas']}, f, default_flow_style=False, sort_keys=False, width=120)
                f.write("\n")
            ...
            if 'activitysim' in new_config:
                ...
                f.write("# =============================================================================\n")
                yaml.dump({'activitysim': new_config['activitysim']}, f, default_flow_style=False, sort_keys=False, width=120)
                f.write("\n")
            ...
            if 'beam' in new_config:
                ...
                f.write("# =============================================================================\n")
                yaml.dump({'beam': new_config['beam']}, f, default_flow_style=False, sort_keys=False, width=120)
                f.write("\n")
            ...
            f.write("# =============================================================================\n")
            yaml.dump({'postprocessing': new_config['postprocessing']}, f, default_flow_style=False, sort_keys=False, width=120)
